...
def run_server():
    ...
    # ----------------------------------------------------------------------- #
    store = ModbusSlaveContext(
        di=ModbusSequentialDataBlock(0, [0]*0xffff),
        co=ModbusSequentialDataBlock(0, [0]*0xffff),
        hr=ModbusSequentialDataBlock(0, [0]*0xffff),
        ir=ModbusSequentialDataBlock(0, [0]*0xffff))
    ...
    # context[0].setValues(4, 105, payload)
    ...
    identity.VendorName = 'Magneto Dynamics'
    identity.ProductCode = 'MD'
    identity.VendorUrl = 'https://magdyn.com/'
    identity.ProductName = 'RGB TND LED'
    identity.ModelName = 'RGB-P67-96HV48-TCP-IP-MB'
